...
describe("opencode run (non-interactive subprocess)", () => {
  ...
  // The budget only discriminates self-exit from hang, so it stays generous:
  // this file spawns 13 concurrent bun subprocesses and a 2-core CI runner
  // pushed the old 15s deadline past its limit (15.7s) without any hang.
  cliIt.concurrent(
