...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const getSmallModel = Effect.fn("Provider.getSmallModel")(function* (providerID: ProviderV2.ID) {
      ...
      const priority = providerID.startsWith("opencode") ? ["gpt-nano"] : smallModelFamilyPriority
      const models = sortBy(
...
const priority = ["gpt-5", "claude-sonnet-4"]
const smallModelFamilyPriority = ["gpt-nano", "claude-haiku"]
