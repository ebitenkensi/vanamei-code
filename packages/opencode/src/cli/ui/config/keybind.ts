...
export const Definitions = {
  ...
  // agent_cycle_reverse is shift+tab but is not wired into the mini footer
  // today, so there is no real conflict. If mini agent-cycle is wired in the
  // future, rebind one of them.
