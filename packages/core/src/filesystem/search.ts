...
// Type-only: a value import would create a runtime cycle with ../filesystem,
// which leaves FileSystemSearch.node undefined in bundled builds depending on
// which side of the cycle the bundler evaluates first.
